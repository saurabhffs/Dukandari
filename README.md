...
3. Make sure you are in the `SpringBoot` directory
...
5. Run the project (by running the `main` method in `dukandariApplication.java`)
...
```properties
    db.url=jdbc:mysql://[ip address of db]:[port of db]/dukanjava?createDatabaseIfNotExist=true
...
2. Click on the `dukandariApplication` configuration
